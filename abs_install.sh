...
build-essential libtool libzmq5-dev autoconf libssl-dev libboost-dev libevent-dev nano jq htop git pwgen libboost-chrono-dev libboost-filesystem-dev libboost-program-options-dev \
